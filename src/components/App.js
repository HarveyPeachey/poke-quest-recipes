    ...
    return (
        ...
        <div className="app-info">
          ...
          <div className="cool-item">
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://www.amazon.com/gp/product/B076HXYKHS/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B076HXYKHS&linkCode=as2&tag=harveypeachey-20&linkId=e1ce3330ec1ae067f1f8011b0917dd98"><img border={0} alt="img" src="//ws-na.amazon-adsystem.com/widgets/q?_encoding=UTF8&MarketPlace=US&ASIN=B076HXYKHS&ServiceVersion=20070822&ID=AsinImage&WS=1&Format=_SL110_&tag=harveypeachey-20" /></a><img src="//ir-na.amazon-adsystem.com/e/ir?t=harveypeachey-20&l=am2&o=1&a=B076HXYKHS" width={1} height={1} border={0} alt="img" style={{border: 'none !important', margin: '0px !important'}} />
          </div>
